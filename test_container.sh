...
curl http://localhost:8001/granules_index -d "collection_name=SSEC__x__IDD-Satellite__x__IR__x__WEST-CONUS_4km__x__WEST-CONUS_4km_IR&catalog_url=http://thredds.ucar.edu/thredds/catalog/satellite/IR/WEST-CONUS_4km/catalog.xml" -X POST


curl 'http://localhost:8001/granules_index?start_time=2018-11-02T23:26:40&end_time=2018-12-30T23:26:40&catalog_url=http://thredds.ucar.edu/thredds/catalog/satellite/IR/WEST-CONUS_4km/catalog.xml'